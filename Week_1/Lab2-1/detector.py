...
#
#     if not os.path.exists("../../YugiohCardDigitizer/samples"):  #or not args.image.lower().endswith(
...
#                 cropped = warped[int(warped.shape[1] // 16):int(warped.shape[1] // 7.7),
#                           int(warped.shape[0] * 0.05):int(warped.shape[0] * 0.73)]
